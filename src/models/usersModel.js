...
import { query, remove, update, create } from '../services/usersService';
...
export default modelExtend(pageModel, {
  ...
  effects: {
    ...
    *update ({ payload }, { select, call, put }) {
    	...
    	//Object.assign(item, { ...newItem, addtime: new Date().getTime() });

     /* const id = yield select((user) => {
      	// console.log(user)
      	return user.users.currentItem.id;
      });
      const addtime = new Date().getTime();
      const newUser = { ...payload, id, addtime };*/
